...
def Path():
    path_model = fd.askopenfilename(filetypes=[("Neural models", ".h5")])
    label_model['text']=path_model
...
label_model = ct.CTkLabel(master=app,text="model3.h5",text_color = "#FCFCFC",text_font=("Bauhaus 93", 10))
